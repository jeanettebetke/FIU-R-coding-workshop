...
R script: [github](https://github.com/SeascapeEcologyLab-workshops/BSC6926-B52_Fall2025/blob/main/workshopScripts/workshop8.R)
...
## Exercises
For these exercises use the [LDWF Pontchartrain seine sampling dataset](https://github.com/SeascapeEcologyLab-workshops/BSC6926-B52_Fall2025/blob/main/data/Pontchartrain.csv). This dataset is the abundance for each species (in wide format) for 16 sites over 1 year.
