...
R script: [github](https://github.com/SeascapeEcologyLab-workshops/BSC6926-B52_Fall2025/blob/main/workshopScripts/workshop9.R)

[R script of workshop 9](workshopScripts/workshop9.R)

[data](https://github.com/SeascapeEcologyLab-workshops/BSC6926-B52_Fall2025/blob/main/data/LDWFseine_monthly2007.csv)
...
tl_init = trajectoryLengths(d, relativeToInitial = T) |> 
      rownames_to_column(var = 'basin') |> 
      as_tibble() |> 
...
[Exercise Solutions](solutions/Key_ws9.html)\