...
R script: [github](https://github.com/SeascapeEcologyLab-workshops/BSC6926-B52_Fall2025/blob/main/workshopScripts/workshop5.R)
...
Now let's see how changing $r_d$ changes the model output using the custom function we created above and `map()`
